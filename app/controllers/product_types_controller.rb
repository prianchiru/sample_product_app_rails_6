class ProductTypesController < ApplicationController
  ...
  def create
    puts "ProductTypeParams: #{product_type_params}"
  ...
  def destroy
    # product_type_fields = ProductFields.find[@product_type[:id]]
    puts "product_type:: #{@product_type.inspect}"
    puts "product_fields:: #{@product_type.product_fields.inspect}"
    # @product_type[:product_fields_attributes] = product_type_fields
    @product_type.product_fields.destroy_all
  ...
  private
    ...
    def product_type_params
      puts "product_type_params::: #{params}"
      params.require(:product_type).permit(:name, product_fields_attributes: [:id, :name, :field_type, :required, :_destroy])
    end
end
